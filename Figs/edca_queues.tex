...
\begin{tikzpicture}[
  ...
  \node[stage, minimum width=2.35cm, minimum height=1.60cm] (vcr) at (10.60,2.40)
  ...
  % Shared medium
  \node[sink] (tx) at (13.30,2.40) {TX onto\\[-1pt]shared medium};
  \draw[arr] (vcr) -- (tx);
  ...
  \node[lbl, anchor=west, align=left] at (8.85,-0.70) {%
