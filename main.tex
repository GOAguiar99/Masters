...
\titulo{Deterministic QoS over Wi-Fi: Bandwidth Reservation and Coordinated Listening for V2X Communication}
% FIXME Substituir 'Subtítulo (se houver)' pelo subtítulo da trabalho.  
% Caso não tenha substítulo, comente a linha a seguir.
% \subtitulo{Uma Alternativa de Baixo Custo}
% FIXME Substituir 'XXXXXX' pelo nome do seu
% orientador.
% \orientador{Prof. Giovani Gracioli, Phd.}
% FIXME Se for orientado por uma mulher, comente a linha acima e descomente a linha a seguir.
\orientador[Supervisor]{Prof. Giovani Gracioli, Phd.}
% FIXME Substituir 'XXXXXX' pelo nome do seu
...
\newacronym[user1=\emph{Acknowledgment}]{ack}{ACK}{confirmação de recebimento}
\newacronym[user1=\emph{Binary Exponential Backoff}]{beb}{BEB}{retirada exponencial binária}
\newacronym[user1=\emph{Carrier Sense Multiple Access with Collision Avoidance}]{csma}{CSMA/CA}{acesso múltiplo por detecção de portadora com prevenção de colisões}
\newacronym[user1=\emph{Distributed Coordination Function}]{dcf}{DCF}{função de coordenação distribuída}
\newacronym[user1=\emph{Deterministic Quality of Service over Wi-Fi}]{dqwifi}{DQ-WiFi}{qualidade de serviço determinística sobre Wi-Fi}
\newacronym[user1=\emph{Institute of Electrical and Electronics Engineers}]{ieee}{IEEE}{instituto de engenheiros eletricistas e eletrônicos}
\newacronym[user1=\emph{Medium Access Control}]{mac}{MAC}{controle de acesso ao meio}
\newacronym[user1=\emph{Physical Layer}]{phy}{PHY}{camada física}
\newacronym[user1=\emph{Quality of Service}]{qos}{QoS}{qualidade de serviço}
\newacronym[user1=\emph{Station}]{sta}{STA}{estação}
...
\glossariolista{Cubesats}{Satélites em cubos pequenos usados para missões espaciais.}
