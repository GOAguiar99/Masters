...
\newacronym[user1=\emph{qualidade de serviço determinística sobre Wi-Fi}]{dqwifi}{DQ-WiFi}{Deterministic Quality of Service over Wi-Fi}
...
\newacronym[user1=\emph{fila first-in first-out}]{fifo}{FIFO}{First-In First-Out}
...
\newacronym[user1=\emph{request for comments}]{rfc}{RFC}{Request for Comments}
...
\newacronym[user1=\emph{estação}]{sta}{STA}{Station}
...
% Declaração dos símbolos (usados no texto/equações)
...
% ---
% 6 - Work Plan (legacy draft until rewritten)
% ---
