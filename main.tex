...
% ABNT prints "SOBRENOME et al." with no comma before "et al."; keep only the
% break opportunity that the redefinition above was introduced for.
\DeclareDelimFormat{andothersdelim}{\allowbreak\space}
...
\newacronym[user1=\emph{categoria de acesso},longplural={Access Categories}]{ac}{AC}{Access Category}
...
\newacronym[user1=\emph{ponto de acesso}]{ap}{AP}{Access Point}
...
\newacronym[user1=\emph{múltiplas entradas e múltiplas saídas}]{mimo}{MIMO}{Multiple-Input Multiple-Output}
...
% ELEMENTOS TEXTUAIS
% ----------------------------------------------------------
% Reset acronym first-use flags so that the lists of figures/tables in the
% front matter do not consume the first expansion of a term in the body.
\glsresetall
\textual
