...
\begin{xltabular}{\linewidth}{@{}
	...
	\midrule
	\endfirsthead
	\caption[]{Simulation parameters used in the crash-aware Veins/\gls*{inet} artifact. (continued)}\\
	\toprule
	\textbf{Parameter} & \textbf{Value} & \textbf{Notes} \\
	\midrule
	\endhead
...
\begin{itemize}
  ...
  \item obstacle loss typename \path{IdealObstacleLoss}, configured from
        \path{highway.obstacles.xml}~\cite{inet_ideal_obstacle_loss};
