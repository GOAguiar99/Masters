...
The radio model uses an IEEE~802.11p physical layer at 5.9~GHz with 10~MHz channelization; reference transmit power, channel index, sensitivity, noise floor, and SNIR threshold are fixed for all policies and recorded with the implementation parameters in \autoref{tab:impl:parameters}.
