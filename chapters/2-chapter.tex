...
Li et al.\ address \gls{bsm} delivery under high vehicle density by combining IEEE~802.11 CSMA/CA with a preemptive-resume priority scheme and an arbitration device, in a setting where a UAV acts as a receiver for BSM uploads toward roadside processing~\cite{PRP_MAC_Li}.
